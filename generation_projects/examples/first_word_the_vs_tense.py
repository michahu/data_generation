...
class FirstWordTheGenerator(data_generator.Generator):
    def __init__(self, pct_restrictive_relative=0.6, uid="first_word_the"):
        super().__init__()
        self.uid = uid
...
if __name__ == "__main__":
    generator = FirstWordTheGenerator()
